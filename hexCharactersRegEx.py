...
# To ensure that you only get the characters you want in a string you will need to use the character classes that accept hexadecimal 
# digits.
...
# You are not allowed to use any of the following characters: \w, \W, \d, \D, \t, \T, \S, \c, ., [, ] as well as any of the letters in 
# the word edabit.
...
print(bool(re.match("^{}$".format(pattern),txt)))
