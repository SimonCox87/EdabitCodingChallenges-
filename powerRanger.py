"""Create a function that takes in n, a, b and returns the number of positive values raised to the nth power that lie in the range 
[a, b], inclusive.
Examples
...
def power_ranger(power, minimum, maximum):
   return sum([i ** (1.0/power) % 1 == 0 for i in range(minimum, maximum + 1)])
